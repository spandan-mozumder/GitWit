...
const Create = () => {
  ...
  function onSubmit(data: FormInput) {
    ...
    const githubUrlPattern =
      /^https:\/\/github\.com\/[a-zA-Z0-9._-]+\/[a-zA-Z0-9._-]+\/?$|^https:\/\/github\.com\/[a-zA-Z0-9._-]+\/[a-zA-Z0-9._-]+\.git$|^git@github\.com:[a-zA-Z0-9._-]+\/[a-zA-Z0-9._-]+(?:\.git)?$/;
      ...
      { name: projectName, repoUrl },
      {
        ...
        onError: (error: { message?: string }) => {
          ...
          if (errorMessage.includes("project with the name")) {
            ...
            errorMessage.includes("project accessing this repository")
          ) {
      ...
      <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.95fr),minmax(0,1fr)]">
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="max-w-xl text-sm leading-relaxed text-muted-foreground md:text-base">
              Bring your repository online to unlock code comprehension,
              decision logs, and execution analytics. It takes less than five
              minutes, and we guide you the whole way.
            </p>
          </div>
          <div className="space-y-4">
            <div className="flex items-start gap-3 rounded-3xl border border-border/70 bg-card/70 p-5">
              ...
              <div className="space-y-1">
                <p className="text-sm font-semibold text-foreground">
                  Stack-aware automation
                </p>
                <p className="text-sm text-muted-foreground">
                  We parse architecture, tests, and rituals so every
                  recommendation fits your reality.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3 rounded-3xl border border-border/70 bg-card/70 p-5">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Keep data residency, SSO, and audit requirements satisfied
                  from day one.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-6 rounded-3xl border border-border/70 bg-card/70 p-6 shadow-lg shadow-primary/5">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Share a GitHub URL and optional token so GitWit can ingest context
