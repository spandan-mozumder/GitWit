      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <p className=" border-t pt-4">{issue.headline}</p>
            <blockquote className="mt-2 border-l-4 border-gray-400 bg-primary-foreground p-3 ">
              <span className="text-sm ">
                ...
                -{" "}
                <span className="bg-gray-500 p-1 rounded-md">{issue.end}</span>
              </span>
              <p className="font-medium mt-2 text-gray-500">{issue.summary}</p>
            </blockquote>
          </DialogHeader>
        </DialogContent>
      </Dialog>
