      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete &quot;{meetingToDelete?.name}&quot;
              and all associated summaries, issues, and insights. This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Every recording becomes searchable context with clear next
                steps.
              </p>
            </div>
            ...
            <Card className="border-dashed border-border/70 bg-card/70">
              <CardContent className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-sm text-muted-foreground max-w-sm">
                  Upload your first recording to receive summaries, sentiment,
                  and action lists within minutes.
                </p>
              </CardContent>
            </Card>
          )}
            ...
            <div className="grid gap-4">
              {meetings?.map(
                (meeting: {
                  ...
                  <Card
                    key={meeting.id}
                    className="overflow-hidden border border-border/70 bg-card/70"
                  >
                        ...
                        <div className="flex-1 space-y-3">
                          <div className="flex items-center gap-3 flex-wrap">
                            ...
                            {meeting.status === "PROCESSING" && (
                              <Badge
                                variant="secondary"
                                className="gap-1.5 rounded-full animate-pulse"
                              >
