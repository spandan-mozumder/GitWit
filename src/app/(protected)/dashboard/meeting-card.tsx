          ...
          },
          {
              ...
              processMeeting
                ...
                .catch((error) => {
                  toast.error("Processing incomplete", {
                    description:
                      "Meeting uploaded but analysis failed. We'll retry automatically.",
                    icon: <AlertCircle className="h-4 w-4" />,
                  });
                });
            },
            onError: (error) => {
              ...
              toast.error("Upload failed", {
                description:
                  error.message ||
                  "Unable to upload meeting. Please try again.",
                icon: <AlertCircle className="h-4 w-4" />,
                duration: 5000,
              });
            },
          ...
          <div className="flex flex-col items-center text-center space-y-4 animate-fade-in">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground max-w-sm">
                Drag in a recording or select an audio file. GitWit will produce
                summaries, follow-ups, and action items in minutes.
              </p>
