  ...
  const coreFeatures = [
    {
      ...
      title: "AI Q&A",
      description:
        "Ask questions about your codebase and get instant, context-aware answers powered by AI.",
      color: "blue",
    ...
    },
    {
      ...
      description:
        "Automatic transcription, summarization, and action item extraction from your team meetings.",
      color: "purple",
  ...
  const tier1Features = [
    {
      ...
      description:
        "Track developer productivity, team metrics, DORA scores, velocity trends, and code hotspots.",
      color: "blue",
      gradient: "from-blue-500/10 to-blue-500/5",
    ...
    },
    {
      ...
      description:
        "Real-time chat with code context, annotations, @mentions, and threaded conversations.",
      color: "green",
    ...
    <div className="container mx-auto p-6 space-y-12 animate-fade-in">
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Everything you need to build better software, faster. AI-powered tools
              ...
              >
                ...
                <CardHeader className="relative">
                  <div className="flex items-start justify-between">
                    <div
                      className={`inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br ${feature.gradient} ${colors.icon}`}
                    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {tier1Features.map((feature) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 ${!isComingSoon && "group-hover:opacity-100"} transition-opacity`}
                />
                <CardHeader className="relative">
                  <div className="flex items-start justify-between">
                    <div
                      className={`inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${feature.gradient} ${colors.icon}`}
                    >
                  ...
                  <ul className="space-y-2 text-sm">
                    {feature.features.map((item, i) => (
                      <li key={i} className="flex items-start gap-2">
                        <div
                          className={`inline-flex h-5 w-5 items-center justify-center rounded-full ${colors.bg} ${colors.icon} mt-0.5`}
                        >
      ...
      <section className="relative overflow-hidden rounded-3xl border border-border/70 bg-gradient-to-br from-primary/5 to-primary/0 p-12 text-center">
        ...
        <div className="relative space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Get started with GitWit today and transform the way your team builds
            software.
          </p>
