...
const CodeBrowserPage = () => {
  ...
  const { data: repoTree, isLoading: loadingTree } =
    api.codeBrowser.getRepoTree.useQuery(
      { projectId: project?.id ?? "" },
      { enabled: !!project },
    );
  const { data: fileContent, isLoading: loadingFile } =
    api.codeBrowser.getFileContent.useQuery(
  ...
  const {
    ...
    refetch: refetchPRs,
  } = api.codeBrowser.getPullRequests.useQuery(
    { projectId: project?.id ?? "" },
  ...
  const buildFileTree = (items: FileItem[]): TreeNode[] => {
    ...
    const convertToArray = (
      obj: Record<string, TreeNodeInternal>,
    ): TreeNode[] => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-sm leading-relaxed text-muted-foreground">
              Browse your entire codebase, view pull requests, and get
      ...
      <Tabs
        value={activeTab}
        onValueChange={(v) => setActiveTab(v as "files" | "prs")}
      >
        ...
        <TabsContent value="prs" className="mt-6">
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              <Button
                onClick={() =>
                  syncPRs.mutate({ projectId: project.id, state: "all" })
                }
                ...
                {pullRequests.map((pr) => {
                  return (
                    <Card
                      ...
                      onClick={() =>
                        router.push(`/code-browser/${pr.prNumber}`)
                      }
                    >
                      <CardHeader>
                          ...
                          <div className="space-y-2 flex-1">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              {pr.riskLevel && (
                                <Badge
                                  variant="outline"
                                  className={riskLevelColors[pr.riskLevel]}
                                >
                                  {pr.riskLevel} Risk
                                </Badge>
                              )}
              ...
              <Card className="border-dashed">
                <CardContent className="flex flex-col items-center justify-center py-16">
                  ...
                  <p className="text-muted-foreground text-center">
                    No pull requests found. Click &quot;Sync Pull Requests&quot;
                    to load them.
                  </p>
                </CardContent>
              </Card>
