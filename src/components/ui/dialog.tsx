    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "gap-6 rounded-2xl border-2 border-border/50 p-8",
          "shadow-2xl shadow-black/20",
          "backdrop-blur-xl",
          "duration-300",
          "sm:max-w-lg",
          "before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-br before:from-primary/10 before:to-transparent before:opacity-50",
          className,
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className={cn(
              ...
              "hover:opacity-100 hover:bg-accent/80 hover:scale-110",
